...
function prepareACImage (power_supply)
        ...
        if online == 1 then
                return "/home/fahmed/.config/awesome/images/power_supply_AC-online.png"
        end
        return "/home/fahmed/.config/awesome/images/power_supply_AC-offline.png"
end

function prepareImage (power_supply)
        if powerSupplyStatus (power_supply) == nil then
                -- battery is physically unavailable
                return "/home/fahmed/.config/awesome/images/battery-unavailable.png"
        end
        if percentLeft (power_supply) == nil then
                return "/home/fahmed/.config/awesome/images/battery-gray.png"
        end
        if percentLeft (power_supply) > 20 then
                return "/home/fahmed/.config/awesome/images/battery-green.png"
        end
        return "/home/fahmed/.config/awesome/images/battery-orange.png"
end
